...
import { updateWorldEntry, addWorldEntry, removeWorldEntry} from './nativeFunctions.mjs' // Defined as const values in nativeFunctions.mjs
import { processInput } from './background.mjs' // Imports functions used for pre-processing the input to e.g determine its type in history.
