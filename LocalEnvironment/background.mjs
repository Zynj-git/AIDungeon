...
export const clearState = () => { const formatData = { "state": { "memory": { "context": "", "frontMemory": "", "authorsNote": "" } }, "memory": "", "worldEntries": [], "history": [] }; fs.writeFileSync("persistentData.json", JSON.stringify(formatData, null, 2)); console.log("State Cleared in persistentData.json"); }